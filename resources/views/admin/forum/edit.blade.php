...
@section('content')
<!-- edit thread for admins -->
<h4>Edit Thread</h4>
<hr>
{!! Form::model($thread, ['route' => ['forum.update', $thread->threadID], 'method' => 'PUT']) !!}
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="thread_edit" name="threadContent" rows="100">{!! $thread->threadContent !!}</textarea>
        </div>
        {{ csrf_field() }}
